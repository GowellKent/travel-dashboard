                    ...
                    <div class="card-body">
                        <div class="row mt-2">
                            ...
                            <div class="col-2 align-right">
                                <router-link :to="{ name: 'objek.create' }" class="btn btn-md btn-success">TAMBAH OBJEK</router-link>
                            </div>
                        </div>
                        <hr>
                        ...
                        <table class="table table-striped table-bordered mt-4">
                            ...
                            <tbody>
                                <tr v-for="data in objeks" :key="data.tot_kode">
                                    <td><router-link :to="{ name: 'objek.edit', params: { id: data.tot_kode } }">{{ data.tot_nama }}</router-link></td>
